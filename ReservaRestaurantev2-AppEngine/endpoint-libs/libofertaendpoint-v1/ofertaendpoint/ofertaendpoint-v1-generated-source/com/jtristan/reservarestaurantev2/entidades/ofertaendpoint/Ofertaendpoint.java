 ...
 * on 2014-05-08 at 13:14:18 UTC 
 * Modify at your own risk.
 */

package com.jtristan.reservarestaurantev2.entidades.ofertaendpoint;
...
public class Ofertaendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the ofertaendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @return the request
   */
  public GetOferta getOferta(java.lang.Long id) throws java.io.IOException {
    GetOferta result = new GetOferta(id);
    initialize(result);
    return result;
  }

  public class GetOferta extends OfertaendpointRequest<com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta> {
    ...
    protected GetOferta(java.lang.Long id) {
      super(Ofertaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta.class);
    ...
    public GetOferta setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * operation.
   *
   * @param content the {@link com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta}
   * @return the request
   */
  public InsertOferta insertOferta(com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta content) throws java.io.IOException {
    InsertOferta result = new InsertOferta(content);
    initialize(result);
    return result;
  }

  public class InsertOferta extends OfertaendpointRequest<com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta> {
     ...
     * @since 1.13
     */
    protected InsertOferta(com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta content) {
      super(Ofertaendpoint.this, "POST", REST_PATH, content, com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta.class);
    }
  ...
  public class ListOferta extends OfertaendpointRequest<com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.CollectionResponseOferta> {
    ...
    protected ListOferta() {
      super(Ofertaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.CollectionResponseOferta.class);
    }
   ...
   * @return the request
   */
  public RemoveOferta removeOferta(java.lang.Long id) throws java.io.IOException {
    RemoveOferta result = new RemoveOferta(id);
    initialize(result);
    return result;
  }

  public class RemoveOferta extends OfertaendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveOferta(java.lang.Long id) {
      super(Ofertaendpoint.this, "DELETE", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    public RemoveOferta setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateOferta updateOferta(com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta content) throws java.io.IOException {
    UpdateOferta result = new UpdateOferta(content);
    initialize(result);
    return result;
  }

  public class UpdateOferta extends OfertaendpointRequest<com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta> {
     ...
     * @since 1.13
     */
    protected UpdateOferta(com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta content) {
      super(Ofertaendpoint.this, "PUT", REST_PATH, content, com.jtristan.reservarestaurantev2.entidades.ofertaendpoint.model.Oferta.class);
    }
